...
import com.example.kotlin.databinding.ViewholderPicListBinding
import com.example.kotlin.databinding.ViewholderSizeBinding
...
class SizeListAdapter(val items: MutableList<String>) :
    ...
    override fun onBindViewHolder(holder: SizeListAdapter.Viewholder, position: Int) {
        ...
        if(selectedPosition==position){
            holder.binding.sizeLayout.setBackgroundResource(R.drawable.purple_bg3)
